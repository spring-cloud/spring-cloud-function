...
A full example of a working pom.xml can be found in the https://github.com/spring-cloud/spring-cloud-function/blob/master/spring-cloud-function-samples/function-sample-gcp/pom.xml[Spring Cloud Functions GCP sample].
...
* The https://github.com/spring-cloud/spring-cloud-function/tree/master/spring-cloud-function-samples/function-sample-gcp/[function-sample-gcp] is an HTTP Function which you can test locally and try deploying.
