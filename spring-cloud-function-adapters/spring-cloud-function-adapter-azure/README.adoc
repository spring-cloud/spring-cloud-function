...
== Sample Function
Go to the link:../../spring-cloud-function-samples/function-sample-azure/README.adoc[function-sample-azure] to learn about how the sample works, and how to run and test it.
